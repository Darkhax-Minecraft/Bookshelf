...
public class Not implements ILoadCondition {
    ...
    public static final Identifier TYPE_ID = BookshelfMod.id("not");
    public static final CachedSupplier<ConditionType> TYPE = CachedSupplier.cache(() -> LoadConditions.getType(TYPE_ID));
    public static final MapCodec<Not> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(LoadConditions.CODEC_HELPER.listCodec("conditions", Not::getConditions)).apply(instance, Not::new));
