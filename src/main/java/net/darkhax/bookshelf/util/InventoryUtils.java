...
public final class InventoryUtils {
    ...
    /**
     * Wrapper for {@link Container#listeners} field. This wrapper exists due to access
     * transformers.
     *
     * @param container The container to access.
     * @return A list of the container listeners.
     */
    ...
    /**
     * Checks if a listener is on a container.
     *
     * @param container The container to check.
     * @param listener The listener to look for.
     * @return Whether or not the container has the listener.
     */
    public static boolean hasListener (Container container, IContainerListener listener) {

        return getListeners(container).contains(listener);
    }
}