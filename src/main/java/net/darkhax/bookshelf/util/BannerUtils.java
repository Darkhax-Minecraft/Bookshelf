...
public final class BannerUtils {
    ...
    /**
     * Creates a new Banner ItemStack that has all of the patterns in the NBTTagList written to it.
     *
    ...
    /**
     * Creates an NBTTagList which contains the data for the banner layers passed. Each layer is
     * stored as a String for the ID and an int that represents an EnumDyeColor. The created
     * NBTTagList can be directly used by the Banner TileEntity. Layers are written in the order
     * they are passed.
     *
     ...
     *
     * @param name The name of the banner pattern being created. This is used for the texture file
     *        and unlocalized name. This is also upper cased to use as the Enum value name.
    ...
    /**
     * Creates a new banner pattern that can only be created by placing a the specified ItemStack
     * into the crafting table as part of the recipe. This pattern can be dyed different colors by
     * adding additional dyes into the recipe.
     *
     * @param name The name of the banner pattern being created. This is used for the texture file
     *        and unlocalized name. This is also upper cased to use as the Enum value name.
     * @param id A short ID to represent the banner pattern. It is critical that this value be
    ...
    /**
     * Creates a new banner pattern that can only be created by placing dyes in the crafting table
     * using a certain arrangement. These recipes only use dye items and can conflict with vanilla.
     * There is roughly 512 possibilities for this.
     *
     * @param name The name of the banner pattern being created. This is used for the texture file
     *        and unlocalized name. This is also upper cased to use as the Enum value name.
     * @param id A short ID to represent the banner pattern. It is critical that this value be
     ...
     *        represented by a string with three characters. A blank space means nothing goes in
     *        that slot, while a # means that a dye would go in that slot. Example: "# #"
     * @param craftingMid A layout for the pattern in the middle row of the crafting grid. This is
     *        represented by a string with three characters. A blank space means nothing goes in
     *        that slot, while a # means that a dye would go in that slot. Example: " # "
     * @param craftingBot A layout for the pattern in the bottom row of the crafting grid. This is
     *        represented by a string with three characters. A blank space means nothing goes in
     *        that slot, while a # means that a dye would go in that slot. Example: "###"
     * @return The pattern that was created.
     */
