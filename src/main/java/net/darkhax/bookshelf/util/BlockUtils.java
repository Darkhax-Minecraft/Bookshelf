...
public final class BlockUtils {
     ...
     * by adjusting for the hardness and other whether or not the player has the right tool.
     *
     ...
     * float that you can use in the event.
     *
     ...
     * @param pos The position of the block.
     * @return A modified speed value that can be used in BreakSpeed to replace the speed of
