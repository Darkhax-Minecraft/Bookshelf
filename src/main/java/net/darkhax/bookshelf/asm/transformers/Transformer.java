...
import static net.darkhax.bookshelf.asm.Mappings.canPushBlock;
...
//                transformCanPushBlock(ASMHelper.getMethodFromClass(itemClass, canPushBlock, "(Lnet/minecraft/block/Block;Lnet/minecraft/world/World;IIIZ)Z"));
//            }
            return ASMHelper.createByteArrayFromClass(itemClass, ClassWriter.COMPUTE_MAXS);
        }
