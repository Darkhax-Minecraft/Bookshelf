...
public class ContainerEnchantmentTransformer implements IClassTransformer {
    ...
    private static String enchantItem = ASMHelper.getAppropriateMapping("enchantItem", "func_75140_a");
    private static String rand = ASMHelper.getAppropriateMapping("rand", "field_75169_l");
    private static String enchantLevels = ASMHelper.getAppropriateMapping("enchantLevels", "field_75167_g");
    private static String buildEnchantmentList = ASMHelper.getAppropriateMapping("buildEnchantmentList", "func_77513_b");
}