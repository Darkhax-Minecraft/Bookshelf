...
public class EntityHorseTransformer implements IClassTransformer {
    ...
    private static String armorValues;
    private static String isHorseSaddled;
    private static String horseTextureArray;
    private static String texturePrefix;
    private static String iron_horse_armor;
    private static String diamond_horse_armor;
    private static String horseChest;

    // Methods
    private static String interact;
    private static String isArmorItem;
    private static String entityInit;
    private static String updateHorseSlots;
    private static String onInventoryChanged;
    private static String getTotalArmorValue;
    private static String setHorseTexturePaths;
    private static String getWatchableObjectItemStack;
    private static String updateObject;
    private static String getHorseArmorIndexSynced;
    private static String getItem;
    private static String playSound;
    private static String isItemEqual;
    private static String addObject;
    private static String getStackInSlot;
