...
public class ItemInventory extends Item implements IInventory {
    ...
    /**
     * Constructs a new Item Inventory. This is an inventory which is stored on an Item. Such an
     * inventory can not contain items of the same type.
     *
    ...
    public ItemInventory (ItemStack invItem, int size, String name) {
        ...
        StackUtils.prepareStackTag(invItem);
        this.readFromNBT();
    }
     ...
     * without creating an entire inventory. Should only be used for reading, and never writing.
     *
