...
public class ModelRetexturable implements IPerspectiveAwareModel {
     ...
     * @param particle The Blockstate of the particle to use for this model.
     */
    public ModelRetexturable (IRetexturableModel baseModel, IBlockState particle) {
     ...
     * ItemStack to the correct model.
     */
    public ModelRetexturable (IRetexturableModel baseModel, IBlockState particle, ImmutableMap<TransformType, TRSRTransformation> transforms, ItemOverrideList itemOverride) {
     ...
     * ItemStack to the correct model.
     */
    public ModelRetexturable (IRetexturableModel baseModel, Function<ResourceLocation, TextureAtlasSprite> spriteGetter, ImmutableMap<TransformType, TRSRTransformation> transforms, boolean ambientOcclusion, boolean gui3d, boolean builtin, IBlockState particle, ItemCameraTransforms cameraTransforms, ItemOverrideList itemOverride) {

        this.baseModel = baseModel;
        this.textureVariable = "blank";
        this.spriteGetter = spriteGetter;
        this.transforms = transforms;
        this.ambientOcclusion = ambientOcclusion;
        this.gui3D = gui3d;
    ...
    public IBakedModel getRetexturedModel (String textureName) {
        ...
        return getRetexturedModel(builder.build());
    }
    ...
    public IBakedModel getDefaultModel () {
        final ImmutableMap.Builder<String, String> builder = ImmutableMap.builder();
        builder.put(this.textureVariable, this.defaultSprite.getIconName());
        ...
        if (state != null) {
            ...
            if (heldState != null){
                ...
                if(iBlockAccess != null && blockPos != null) {
                    ...
                    if(e instanceof ITileEntityRender)
                        return this.getRetexturedModel(((ITileEntityRender) e).getRenderStates()).getQuads(state, side, rand);
                }

                final ImmutableMap.Builder<String, String> builder = ImmutableMap.builder();
                builder.put(this.textureVariable, RenderUtils.getSprite(heldState).getIconName());
