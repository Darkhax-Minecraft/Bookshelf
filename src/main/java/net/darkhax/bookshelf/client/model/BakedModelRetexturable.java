 ...
 * https://goo.gl/Aup8MK
 */
public class BakedModelRetexturable implements IPerspectiveAwareModel {
     ...
     *        generated.
     */
    public BakedModelRetexturable (IRetexturableModel baseModel, String textureVariable, IBlockState particle, ImmutableMap<TransformType, TRSRTransformation> transforms, ItemOverrideList itemOverride, TextureAtlasSprite defaultSprite) {
