...
public class GuiGraphicButton extends GuiButton {
    ...
    /**
     * The image to draw on the button. By default this image is a random file
     * that probably doesn't exist. This texture can be changed in the
     * constructor.
     */
    private ResourceLocation buttonImage = new ResourceLocation("textures/gui/widgets.png");

    /**
     * Constructs a new graphic button. A graphic button is a 20x20 button that
     * uses an image rather than text.
     *
     * @param buttonID The ID to set for the button. This ID is specific to the
     *        GUI instance.
     * @param xPosition The X coordinate to position the button at.
     * @param yPosition The Y coordinate to position the button at.
     * @param texture The texture to use for the button. This should be a 20x20
     *        image.
     */
