...
public class ForgeRegistryHelper<T extends IForgeRegistryEntry<T>> {
    ...
    /**
     * Registers a value supplier which will be resolved during
     * {@link #injectRegistryEntries(Register)}. This method bypasses some of the safety checks
     * and {@link #registerListeners} so extra caution should be used.
     * 
    ...
    /**
     * Gets all the registered values. May only be called after
     * {@link #injectRegistryEntries(Register)}.
     * 
    ...
    /**
     * Checks if the registry helper has been initialized. This happens when
     * {@link #initialize(IEventBus)} has ahpped. You can not add entries to an initialized
     * registry helper.
     * 
    ...
    /**
     * Checks if the registry helper has been registered yet. This happens when
     * {@link #injectRegistryEntries(Register)} has happened.
     * 
     * @return
     */
