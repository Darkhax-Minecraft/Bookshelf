...
public abstract class ItemModelledArmor extends ItemArmor {
     ...
     *
     * @param pass: The current pass Minecraft is rendering. This is 1 for the leggings, and 0
     ...
     *
     * @return String: The full string path to the texture. Minecraft will use the texture file
     *         ending with "_0" for the leggings, and "_1" for the other pieces. Make sure NOT
     *         to add the suffices to the texture path. EG:
     *         testmod:textures/entity/player/armor/player_armor_test
     */
