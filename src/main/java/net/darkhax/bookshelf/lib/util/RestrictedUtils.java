...
public class RestrictedUtils {
	...
	/**
	 * Access to the guiLeft field in GuiContainer. Used to get the starting X position of a GUI.
	 */
	private static Field guiLeft = null;
	
	/**
	 * Access to the guiTop field in GuiContainer. Used to get the starting Y position of a GUI.
	 */
	private static Field guiTop = null;
	
	/**
	 * Retrieves the starting X position of a Gui. This is handled through reflection. If the guiLeft field has not been made accessible, this method will do that.
	...
	/**
	 * Retrieves the starting Y position of a Gui. This is handled through reflection. If the guiTop field has not been made accessible, this method will do that.
