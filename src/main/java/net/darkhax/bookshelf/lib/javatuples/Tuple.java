        ...
        implements Iterable<Object>, Serializable, Comparable<Tuple>
{
    ...
    public static Tuple readFromByteBufStream(ByteBufInputStream stream) {
        ...
        try {
            odis = new ObjectDecoderInputStream(stream);

            return (Tuple) odis.readObject();
        } catch( IOException ioEx ) {
            Constants.LOG.log(Level.ERROR, "Cannot deserialize Tuple!", ioEx);
        } catch( ClassNotFoundException cnfEx ) {
            Constants.LOG.log(Level.ERROR, "Cannot deserialize Tuple!", cnfEx);
        } finally {
            try {
                if (odis != null) {
                    odis.close();
                ...
                Constants.LOG.log(Level.ERROR, "Cannot properly close ObjectDecoderInputStream!", ex);
            }
        }
    ...
    public static void writeToByteBufStream(Tuple tuple, ByteBufOutputStream stream) {
        ...
        try {
            oeos = new ObjectEncoderOutputStream(stream);
            ...
            try {
                ...
                Constants.LOG.log(Level.ERROR, "Cannot properly close ObjectEncoderOutputStream!", ex);
            }
        }
    }
