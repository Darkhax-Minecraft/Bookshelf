...
public enum ModifierOperation {
     ...
     * base is 2 and the value is 3, the result would be 8. (2 * (1 + 3) = 8) If another
     * modifier of the same type is added but it had a value of 4 the new sum would be 16. (2 *
     * (1 + 3 + 4) = 15)
     */
    MULTIPLY,
     ...
     * value is 3 and you had two of these modifiers, one with an amount of 2 and the other
