...
public class PotionEffectEvent extends Event {
    ...
    /**
     * Constructs a new PotionEffectEvent. This event itself is never called, only the 3 child events.
     *
    ...
    public static class PotionEffectStartEvent extends PotionEffectEvent {
        ...
        /**
         * Constructs a new PotionEffectStartEvent. This event is triggered when a potion effect gets
         * used on a living entity.
         *
         * @param potion: The potion effect getting used.
         * @param entity: The entity with the potion effect.
         */
    ...
    public static class PotionEffectChangeEvent extends PotionEffectEvent {
        ...
        /**
         * Constructs a new PotionEffectChangeEvent. This event is triggered when a potion effect gets
         * updated.
         *
         * @param potion: The potion effect getting used.
         * @param entity: The entity with the potion effect.
    ...
    public static class PotionEffectFinishEvent extends PotionEffectEvent {
        ...
        /**
         * Constructs a new PotionEffectFinishEvent. This event is triggered when a potion effect gets
         * worn out.
         *
         * @param potion: The potion effect getting used.
         * @param entity: The entity with the potion effect.
