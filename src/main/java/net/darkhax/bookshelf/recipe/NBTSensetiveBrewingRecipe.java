...
public class NBTSensetiveBrewingRecipe extends AbstractBrewingRecipe<ItemStack> {
    
    public NBTSensetiveBrewingRecipe(ItemStack input, ItemStack ingredient, ItemStack output) {
